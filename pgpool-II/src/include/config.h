...
/* Define to 1 if you have the `PQpingParams' function. */
#define HAVE_PQPINGPARAMS 1
...
#define PACKAGE_BUGREPORT "pgpool-hackers@lists.postgresql.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "pgpool-II"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "pgpool-II 4.7.1"
